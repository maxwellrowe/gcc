<footer class="bg-gray-300 pt-1" id="global-footer">
	<div class="footer-college-outline text-center" data-aos="fade-up">
		<img src="/gcc/_resources/images/footer-college-outline.svg" alt="Drawing of Glendale City College" />
	</div>
	<div class="py-4">
		<div class="container-xxl">
			<div class="row gy-3">
				<div class="col-12 col-md-6 col-lg-2 order-lg-1 text-center text-md-start">
				...
				<div class="col-12 col-md-6 col-lg-2 order-lg-3 mb-3">
				...
				<div class="col-12 text-center text-md-start col-lg-8 order-lg-2">
					<div class="row gy-3">
