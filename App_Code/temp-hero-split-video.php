...
error_reporting(E_ALL);
	...
	$page_title = 'Example of Split Hero with Video';
					...
					<header id="page-header" class="page-hero border-0 bg-red-gradient rounded overflow-hidden p-0">
						<div class="row gap-0 row-cols-1 row-cols-lg-2 align-items-start align-items-lg-center">
							...
							<div class="col order-1 order-lg-2">
								<a href="#" class="component-video-modal match-height-row page-hero-image d-block" data-bs-toggle="modal" data-bs-target="#page-hero-video-modal" arial-label="Play Video Caption" style="background-image: url('/gcc/_resources/images/placeholder_students.jpg');">
