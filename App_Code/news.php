	...
	<body class="<?php echo implode(' ', $body_classes); ?>">
		...
		<div class="main-wrapper d-flex justify-content-center align-items-stretch">
			<main id="main-content" class="flex-grow-1">
				...
				<section class="mb-4">
					<div class="container">
						<h2 class="preheading preheading-arrow">Latest Articles</h2>
						
						<div class="row gx-lg-4">
							<div class="col-12 col-md-6">
								<a href="" class="card news-card border-0">
									<div class="card-body p-0">
										<img src="/gcc/_resources/images/news-1.jpg" class="rounded" alt="Image Title" data-aos="fade" />
										<h3 class="mt-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</h3>
										<p>Proin eu ultricies elit, sed tempor neque. Nunc scelerisque venenatis velit vel mattis. Aenean maximus pellentesque magna nec porta.</p>
										<p class="fs-7">February 2, 2025</p>
									</div>
								</a>
							</div>
							<div class="col-12 col-md-6">
								<a href="" class="card news-card news-card-horizontal border-0 mb-2">
									<div class="card-body p-0">
										<div class="row">
											...
											<div class="col-12 col-md-8 order-lg-1">
												...
												<p class="fs-7">Proin eu ultricies elit, sed tempor neque. Nunc scelerisque venenatis velit vel mattis. Aenean maximus pellentesque magna nec porta.</p>
				...
				<section class="mt-4">
					<div class="container">
						<h2 class="preheading preheading-arrow mb-4">All News</h2>
